...
- **Palette:** warm cream background, slightly lighter cream cards, near-black ink, deep brick red accent (title italic, hero batch numeral, AUTO micro-label). Size colors as thick left card borders + dot bullets: Indi green, Small brick red, Large blue, Sic magenta, Boil purple.
...
- **02 Current Dough Counts** ("TRAYS + SINGLES"): color cards with live "= N balls" — Individual "11 / tray", Small "8 / tray", Large "6 / tray" (Trays + Singles each), Sicilian "balls only" (one Balls field), Boil Dough "target 36 · 6 / tray" (Trays + Singles). Integer keypads.
...
- **04 By Size** ("TONIGHT → EON → TOMORROW"): rows Indi/Sm/Lg/Sic with columns HAVE | USE | LEFT | NEED | MAKE | TRAYS (Sic's TRAYS cell displays balls, labeled BALLS; shortages red with the raw negative). Separate Boil row: HAVE | TARGET 36 | MAKE, "whole trays only".
